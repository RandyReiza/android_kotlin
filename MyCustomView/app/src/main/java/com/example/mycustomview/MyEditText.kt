...
class MyEditText : AppCompatEditText, View.OnTouchListener {
    ...
    private fun showClearButton() {
        setCompoundDrawablesRelativeWithIntrinsicBounds(null, null, mClearButtonImage, null)    // meletakan gambar "clear" pada posisi end
    }
    ...
    // ketika komponen editText ditekan
